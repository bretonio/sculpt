<?php
	...
	$bg_color = get_sub_field('textModule_bg_color');
...
<section class="textModule container" style="<?php echo 'background-color:'.$bg_color.';color:'.$text_color.';' ?>">
	...
	<?php } elseif ($layout == 'fourUp') { ?>
		<div class="textModule-block block s1 med_s13 lg_s14">
			<?php if ($col_1_url) { ?>
				<a href="<?php echo $col_1_url; ?>" class="textModule-block-link">
					<h3><?php echo $col_1_title; ?></h3>
				</a>
