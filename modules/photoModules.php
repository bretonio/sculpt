...
<section class="container photoModule<?php echo ' '.$size ?>">
	<div class="row">
		...
		<?php } elseif ($layout == 'fourUp') { ?>
			...
			<div class="block photoModule-photo photoModule-fourUp s12 lg_s14 js-lazy" data-original="<?php echo $photo34; ?>"></div>
			<div class="block photoModule-photo photoModule-fourUp s12 lg_s14 js-lazy" data-original="<?php echo $photo44; ?>"></div>
		<?php } ?>
	</div>
</section>